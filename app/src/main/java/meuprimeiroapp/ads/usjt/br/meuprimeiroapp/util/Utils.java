...
package meuprimeiroapp.ads.usjt.br.meuprimeiroapp.util;
...
public class Utils {
    ...
    private static meuprimeiroapp.ads.usjt.br.meuprimeiroapp.util.StatusTracker mStatusTracker = meuprimeiroapp.ads.usjt.br.meuprimeiroapp.util.StatusTracker.getInstance();
